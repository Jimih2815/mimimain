  ...
  <style>
    ...
    /* === Global Mobile Overrides (tất cả các trang) === */


/* === Return Policy – Mobile styles (<=576px) === */
...
#mcFloatingPanel {
  ...
  /* Hero */
  .rp-hero {
    padding: 3rem 1rem;               /* giảm padding để vừa màn hình */
  }
  .rp-hero h1 {
    font-size: 2rem;                  /* chữ vừa đủ nổi bật */
  }
  .rp-hero p.lead {
    font-size: .95rem;
  }
  ...
  /* Wrapper */
  .w-50 {
    width: 90% !important;            /* mở rộng thành 90% */
    margin: 0 auto;
  }
