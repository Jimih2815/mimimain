...
|--------------------------------------------------------------------------
|
| Tất cả route /admin/* đều nằm trong đây. 
| Middleware: auth (và bạn có thể thêm isAdmin nếu cần)
| Prefix name = admin.
|
*/

Route::prefix('admin')
     ->middleware(['auth'])          // hoặc ['auth','isAdmin']
     ->name('admin.')
     ->group(function(){
    ...
    // 3) Quản lý Products (CRUD + thêm options)
