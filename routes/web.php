...
//
// AUTH CONTROLLERS (guest-only và auth-only)
//
...
Route::prefix('admin')
    ...
    // 4.2 Mega‐menu (MenuSection + MenuGroup + sản phẩm)
    ...
    // Chỉ định 2 route cho Home Section Images
    Route::get ('home-section-images', [HomeSectionImageController::class,'index'])
         ->name('home-section-images.index');
    Route::post('home-section-images', [HomeSectionImageController::class,'update'])
         ->name('home-section-images.update');
...
/*
|--------------------------------------------------------------------------
| 5. Redirect khi có dấu slash thừa ở cuối URL
|--------------------------------------------------------------------------
*/
